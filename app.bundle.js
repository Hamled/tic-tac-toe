...
/***/ function(module, exports, __webpack_require__) {
	...
	var _application_view = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backbone = __webpack_require__(302);
	...
	var _game_view = __webpack_require__(305);
	...
	var ApplicationView = _backbone2.default.View.extend({
	  initialize: function initialize(options) {
	    this.gameView = new _game_view2.default({
	      el: this.$('#board')
	    });
	    this.listenTo(this.gameView, 'restart', this.restart);

	    this.setupTemplate = _underscore2.default.template(_backbone2.default.$('#tmpl-setup-form').html());
	  },
	  ...
	  newGame: function newGame(playerX, playerO) {
	    // Create a new Game model
	    this.currentGame = new _game2.default({
	      playerX: playerX,
	      playerO: playerO
	    });
	  ...
	  onStart: function onStart(e) {
	    var playerX = this.$('input[name="playerX"]').val();
	    var playerO = this.$('input[name="playerO"]').val();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = _base2.default.extend({
	  ...
	  initialize: function initialize(options) {
	    ...
	    var board = new Array(Game.BOARD_POS_MAX + 1);
	    ...
	    this.set({
	      players: [options.playerX, options.playerO],
	  ...
	  // Instance Methods
	  playerX: function playerX() {
	    return this.get('players')[0];
	  },

	  playerO: function playerO() {
	    return this.get('players')[1];
	  },

	  currentPlayer: function currentPlayer() {
	    return this.turn % 2 === 0 ? this.playerO() : this.playerX();
	  },
	  ...
	  outcome: function outcome() {
	    var self = this;
	    var isWin = function isWin(pos1, pos2, pos3) {
	      return self.boardAt(pos1) === self.boardAt(pos2) && self.boardAt(pos1) === self.boardAt(pos3) && self.boardAt(pos1) !== Game.EMPTY_CELL;
	    };
	  ...
	  boardAt: function boardAt(position) {
	    if (!Game.isValidPosition(position)) {
	  ...
	  playerMark: function playerMark(player) {
	  ...
	  boardString: function boardString() {
	    var self = this;
	    var rowString = function rowString(row) {
	    ...
	    var dividerString = function dividerString() {
	      return '---+---+---\n';
	    };

	    return rowString(0) + dividerString() + rowString(1) + dividerString() + rowString(2);
	  },
	  ...
	  toJSON: function toJSON() {
	    ...
	    var json = _base2.default.prototype.toJSON.call(this);
	  ...
	  isValidPosition: function isValidPosition(position) {
	    return Number.isInteger(position) && position >= this.BOARD_POS_MIN && position <= this.BOARD_POS_MAX;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Base = _backbone2.default.Model.extend({
	  ...
	  get: function get(attr) {
	    var value = _backbone2.default.Model.prototype.get.call(this, attr);
	    return _underscore2.default.isFunction(value) ? value.call(this) : value;
	  },

	  toJSON: function toJSON() {
	    var self = this;
	    var json = _backbone2.default.Model.prototype.toJSON.call(this);
	    return _underscore2.default.mapObject(json, function (value, attr) {
	      return _underscore2.default.isFunction(value) ? value.call(self) : value;
	    });
	  },
	  ...
	  set: function set(key, val, options) {
	    var self = this;
	    var super_set = function super_set(attrs) {
	      return _backbone2.default.Model.prototype.set.call(self, attrs, val, options);
	    };
	    ...
	    if ((typeof key === 'undefined' ? 'undefined' : _typeof(key)) === 'object') {
	      var attrs = _underscore2.default.omit(key, function (value, attr) {
	        return _underscore2.default.isFunction(self.attributes[attr]);
	      });
	      return super_set(attrs);
	    } else {
	      if (!_underscore2.default.isFunction(self.attributes[key])) {
	        return super_set(key);
	      }
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    this.msgTemplate = _underscore2.default.template(_backbone2.default.$('#tmpl-overlay-msg').html());
	  },
	  ...
	  render: function render() {
	    var placedTiles = this.$('.placed-tiles');
	  ...
	  onPlay: function onPlay(e) {
	    var cell = e.target;
	    var position = this.posFromCell(cell);

	    this.model.play(position);
	  },

	  posFromCell: function posFromCell(cell) {
	    var cellID = this.$(cell).attr('id');
	    return Number.parseInt(cellID.replace('cell-', ''));
	  },

	  onRestart: function onRestart(e) {
